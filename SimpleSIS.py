...
class Home(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="forest green")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "STUDENT INFORMATION SYSTEM",bd=4,relief=RIDGE, font=("Times new roman",40,"bold"),bg="white", fg="Gray10")
...
#________WINDOW BUTTONS________#
        ...
        Button1 =ssis.Button(self, text="STUDENTS",font=("Times new roman",25,"bold"),bd=10, width = 10,bg="#cdc9c9",fg="black",command=lambda: controller.ShowFrame(Student))
        Button1.place(x=525,y=500)
...
class Course(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="forest green")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "C O U R S E",bd=4, relief=RIDGE, font=("Times new roman",40,"bold"),bg="white", fg="Black")
...
#________WINDOW BUTTONS________#
        ...
        Button1 = ssis.Button(self, text="HOME",font=("Times new roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="black",command=lambda: controller.ShowFrame(Home))
        Button1.place(x=265,y=550)
        Button2 =ssis.Button(self, text="STUDENTS",font=("Times new roman",25,"bold"),bd=10, width = 10,bg="#cdc9c9",fg="black",command=lambda: controller.ShowFrame(Student))
        Button2.place(x=790,y=550)
        
#________LABELS AND ENTRIES________#
        
        self.lblCourseCode = Label(self, font=("Time new roman", 22, "bold"), text="COURSE CODE:", padx=5, pady=5, bg = "GHOSTWHITE", fg = "black")
        ...
        self.lblCourseName = Label(self, font=("Time new roman", 22,"bold"), text="COURSE NAME:", padx=5, pady=5, bg = "GHOSTWHITE", fg = "black")
        ...
        self.SearchBarlbl = Label(self, font=("Time new roman", 18,"bold"), text="Course code:", padx=5, pady=5, bg = "GHOSTWHITE", fg = "black")
...
#________TREEVIEW________#
        ...
        style = ttk.Style()
        style.configure("Treeview.Heading", font=("Times new roman",18,"bold"),foreground="Black")
...
#________COURSE BUTTONS________#
        ...
        self.btnAddID = Button(ButtonFrame, text="ADD", font=("Times new roman", 20, "bold" ), height=1, width=10, bd=1,bg="snow3", fg="black",command=addCourse)
        self.btnAddID.place(x=40,y=10)
        self.btnUpdate = Button(ButtonFrame, text="UPDATE", font=("Times new roman", 20, "bold"), height=1, width=10, bd=1,bg="#cdc9c9", fg="black", command=updateCourse) 
        self.btnUpdate.place(x=280,y=10)
        self.btnClear = Button(ButtonFrame, text="CLEAR", font=("Times new roman", 20, "bold"), height=1, width=10, bd=1,bg="#cdc9c9", fg="black", command=clear)
        self.btnClear.place(x=40,y=90)
        self.btnDelete = Button(ButtonFrame, text="DELETE", font=("Times new roman", 20, "bold"), height=1, width=10, bd=1,bg="#cdc9c9", fg="black", command=deleteCourse)
        self.btnDelete.place(x=280,y=90)
        self.btnSearch = Button(self,text= "SEARCH",font=("Times new roman", 16,"bold"), bg = "#cdc9c9", fg = "gray35", command=searchCourse)
        self.btnSearch.place(x=1050,y=45)
        self.btnRefresh = Button(self, text="Refresh", font=('Times new roman', 14, "bold"), height=1, width=10, bg="#cdc9c9", fg="GHOSTWHITE", command=Refresh)
...
class Student(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="forest green")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "STUDENT INFORMATION",bd=4, font=("Times new roman",30,"bold"),bg="white", fg="black")
...
#________WINDOWS BUTTON________#
        ...
        Button1 =ssis.Button(self, text="COURSE",font=("Times new roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="black",command=lambda: controller.ShowFrame(Course))
        Button1.place(x=265,y=550)
        Button2 = ssis.Button(self, text="HOME",font=("Times new roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="black",command=lambda: controller.ShowFrame(Home))
        Button2.place(x=790,y=550)
...
#_______LABELS AND ENTRIES_______#
        ...
        self.lblStudentID = Label(InfoFrame, font=("Times new roman", 16,"bold"), text="ID No:", padx=5, pady=5, bg = "white", fg = "BLACK", width = 10)
        self.lblStudentID.place(x=10,y=20)

        self.txtStudentID = Entry(InfoFrame, font=("Times new roman", 16), textvariable=Student_ID, width=26, fg = "BLACK")
        self.txtStudentID.place(x=160,y=25)
        self.txtStudentID.insert(0,'YYYY-NNNN')

        self.lblStudentName = Label(InfoFrame, font=("Times new roman", 15,"bold"), text="FULL NAME:", padx=5, pady=5, bg = "white", fg = "BLACK",  width = 10)
        self.lblStudentName.place(x=10,y=75)
        self.txtStudentName = Entry(InfoFrame, font=("Times new roman", 16), textvariable=Student_Name, width=26, fg = "BLACK")
        self.txtStudentName.place(x=160,y=80)

        self.lblStudentCourse = Label(InfoFrame, font=("Times new roman", 16,"bold"), text="COURSE:", padx=5, pady=5, bg = "white", fg = "BLACK",  width = 10)
        self.lblStudentCourse.place(x=10,y=145)
        self.txtStudentCourse = Entry(InfoFrame, font=("Times new roman", 16), textvariable=Course_Code, width=26, fg = "black")
        self.txtStudentCourse.place(x=160,y=150)

        self.lblStudentYearLevel = Label(InfoFrame, font=("Times new roman", 15,"bold"), text="YEAR LEVEL:", padx=5, pady=5, bg = "white", fg = "BLACK",  width = 10)
        ...
        self.lblStudentGender = Label(InfoFrame, font=("Times new roman", 16,"bold"), text="GENDER:", padx=5, pady=5, bg = "white", fg = "BLACK",  width = 10)
        self.lblStudentGender.place(x=10,y=285)
        self.txtStudentGender = ttk.Combobox(InfoFrame, value=["Male", "Female"], font=("Times new roman", 16),state="readonly", textvariable=Student_Gender, width=25, style="combostyleO.TCombobox")
        self.txtStudentGender.place(x=160,y=290)

        self.SearchBarlbl = Label(self, font=("Time new roman", 18,"bold"), text="Id Number:", padx=2, pady=2, bg = "white", fg = "black")
...
#________STUDENT BUTTONS______#
        ...
        self.btnAddID = Button(ButtonFrame, text="ADD", font=('Times new roman', 18, "bold" ), height=1, width=7, bd=1,bg="#cdc9c9", fg="black",command=addData)
        self.btnAddID.place(x=7,y= 10)
        self.btnUpdate = Button(ButtonFrame, text="UPDATE", font=('Times new roman', 18, "bold"), height=1, width=7, bd=1,bg="#cdc9c9", fg="black", command=updateData) 
        self.btnUpdate.place(x=264,y=10)
        self.btnClear = Button(ButtonFrame, text="CLEAR", font=('Times new roman', 18, "bold"), height=1, width=7, bd=1,bg="#cdc9c9", fg="black", command=clear)
        self.btnClear.place(x=133,y=10)
        self.btnDelete = Button(ButtonFrame, text="DELETE", font=('Times new roman', 18, "bold"), height=1, width=7, bd=1,bg="#cdc9c9", fg="black", command=deleteData)
        self.btnDelete.place(x=398,y=10)
        self.btnSearch = Button(self,text= "SEARCH",font=("Times new roman", 16,"bold"), height=1, width=8, bg = "#cdc9c9", fg = "black", command=searchData)
        self.btnSearch.place(x=1099,y=42)
        self.btnRefresh = Button(self, text="Refresh", font=('Times new roman', 14, "bold"), height=1, width=7, bg="#cdc9c9", fg="black", command=Refresh)
